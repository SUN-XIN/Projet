...
//	$_POST[numE_AR] numéro d'exemplaire de la cassette à rentrer
	...
	if ($res!="") {
		...
		echo "<a href='AccueilRetourBis.php' title='AccueilRetour'>AccueilRetour</a><br />";
		echo "<a href='indexBis.htm' title='Gestion'>Session Gestion</a>";
	}
	else {
		echo "Erreur de saisir. Cassette concernée n'est pas trouvée.<br />";
		echo "<a href='AccueilRetourBis.php' title='AccueilRetour'>Retourner à la page precedente.</a><br />";
